 ...
 */
public class douebleLnkList<T> {

    nodeDL first;
    nodeDL last;

    public void insertFirst(T data) {
        nodeDL node = new nodeDL(data); //creación del nodo
    ...
    public void insertLast(T data) {
        ...
        nodeDL node = new nodeDL(data);//creación de nodo
  ...
  public void eNodeFirst() {
    ...
    public boolean eNODE(T data) {
        nodeDL aux = searchNode(data);// creamos un auxiliar de tipo nodo que recibira información del metodo que busca nodos
    ...
    public void showList() {//Método para mostrar la lista
        nodeDL aux1;//declaramos dos variables auxiliares tipo nodeDL para guardar los valores de nuestros nodos
        aux1 = (nodeDL) first;// aux1 sera igual a first
    ...
    public void showLastFirst() {
        nodeDL aux1;//declaramos dos variables auxiliares tipo nodeDL para guardar los valores de nuestros nodos
        aux1 = (nodeDL) last;// aux1 sera igual a first
